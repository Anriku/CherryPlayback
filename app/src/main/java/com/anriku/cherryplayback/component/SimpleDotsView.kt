 ...
 */
class SimpleDotsView : SlideShowView.DotsView {
    ...
    constructor(context: Context, attrs: AttributeSet?, defStyleAttr: Int) :
        ...
        mDotRadius = typeArray.getDimensionPixelSize(R.styleable.SimpleDotsView_dotRadius, dip(3))
